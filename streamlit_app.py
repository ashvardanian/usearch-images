...
columns: int = st.sidebar.slider("Grid Columns", min_value=1, max_value=10, value=5)
...
size: int = client.size(dataset_name).json
...
st.success(f"Found {len(results):,} matches among {size:,} entries!", icon="✅")
